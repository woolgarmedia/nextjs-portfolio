...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
      <loc>https://blog.woolgarmedia.co.uk</loc>
  </url>
  <url>
      <loc>https://blog.woolgarmedia.co.uk/blog</loc>
  </url>
</urlset>
```
...
> **Note:** `globby` [might not work](https://github.com/leerob/blog.woolgarmedia.co.uk/issues/293) on Windows.
    ...
    <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
        ${pages
          .map((page) => {
            ...
            return `
              <url>
                  <loc>${`https://blog.woolgarmedia.co.uk${route}`}</loc>
              </url>
            `;
          })
          .join('')}
...
```bash
User-agent: *
Sitemap: https://blog.woolgarmedia.co.uk/sitemap.xml
```
