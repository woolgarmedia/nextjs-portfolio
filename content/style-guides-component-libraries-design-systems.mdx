...
inside Markdown files. The blog you're reading right now [uses this](https://github.com/leerob/blog.woolgarmedia.co.uk).
...
Feel free to [reach out](mailto:me@blog.woolgarmedia.co.uk) if you wanna chat about building design systems.
