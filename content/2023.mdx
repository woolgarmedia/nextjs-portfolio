...
Another example is on [my work page](https://blog.woolgarmedia.co.uk/work). I love that I can drop this component in anywhere:
...
As always, my entire site is [open source](https://github.com/leerob/blog.woolgarmedia.co.uk). Feel free to fork it and hack around.
